    ...
    return(
        <div style={{width:'270px', height:'75px', marginTop:'20px', display:'flex'}}>
            <Row style={{alignItems:'center'}}>
                <Col>
                    <Image src={profile_photo ? profile_photo : '/default_user.jpg'} roundedCircle style={{height:'60px', width:'auto'}} />
                </Col>
                <Col>
                    <Row>
                        <Col>
                            <p style={{margin:'0', fontSize:'18px', color:'white', textAlign:'center', fontWeight:'500'}}>{username_profile ? username_profile : 'unknown'}</p>
